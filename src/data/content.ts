...
export const events: Event[] = [
  {
    id: '1',
    slug: 'directors-founders-meetup',
    ...
    longDescription: 'The Directors & Founders Meetup is the room where decisions get easier. A capped guest list of forty operators — most running businesses between £1M and £50M in revenue — share an evening of honest conversation. No panels, no pitches, no badges with job titles. Just the people you actually want to be sitting next to.',
    highlights: [
      'Forty curated guests, hand-reviewed before invitation',
      'Two hours of structured roundtables on shared challenges',
      'Founder-only fireside conversation in the second hour',
      'Drinks, food, and an unhurried close-out',
    ],
    whoFor: [
      'Founders and CEOs running established businesses',
      'Directors at growth-stage companies',
      'Operators thinking about the next chapter',
    ],
    image: '/images/london/1.webp',
    schedule: [
      { time: '6:30 PM', label: 'Arrival & welcome drinks' },
      { time: '7:00 PM', label: 'Roundtables open' },
      { time: '8:00 PM', label: 'Founder fireside' },
      { time: '9:00 PM', label: 'Open networking & close' },
    ],
  },
  {
    id: '2',
    slug: 'founders-investors-night',
    ...
    longDescription: 'Most investor events feel like speed-dating with worse lighting. This one doesn\'t. We bring twenty operators raising in the next twelve months into a room with fifteen active investors — angels, seed funds, and a few growth-stage check writers — and let the evening do the work. Pitches happen, but only when both sides want them to.',
    highlights: [
      'Twenty founders, fifteen investors, one capped room',
      'Sector mix vetted to make matches actually relevant',
      'Quiet corners for follow-up conversations',
      'Intro warm-ups by the team — no cold approaches needed',
    ],
    whoFor: [
      'Founders raising pre-seed through Series A',
      'Angel investors and early-stage funds',
      'Operators considering an angel portfolio',
    ],
    image: '/images/london/2.webp',
    schedule: [
      { time: '6:30 PM', label: 'Arrival & matchmaking briefing' },
      { time: '7:00 PM', label: 'Curated introductions' },
      { time: '8:00 PM', label: 'Open floor & quiet corners' },
      { time: '9:30 PM', label: 'Wrap & follow-up swap' },
    ],
  },
  {
    id: '3',
    slug: 'small-business-mastermind',
    ...
    longDescription: 'The Mastermind is a working session, not a mixer. Twelve owners around one table, two hours, one hot seat each. You bring the real problem you\'re sitting on this week — the one you haven\'t solved yet — and the room helps you move it forward. We\'ve seen pricing rewrites, hiring decisions, and partnership deals come out of a single evening.',
    highlights: [
      'Twelve seats per session — every voice gets airtime',
      'Hot-seat format with structured feedback rounds',
      'Confidentiality understood and respected',
      'Notes and action items captured for every attendee',
    ],
    whoFor: [
      'Owners of businesses between £200k and £5M in revenue',
      'Operators wearing every hat and needing real peers',
      'Anyone tired of generic advice from people who haven\'t done it',
    ],
    image: '/images/london/3.webp',
    schedule: [
      { time: '6:30 PM', label: 'Arrival & check-in round' },
      { time: '7:00 PM', label: 'Hot seats begin' },
      { time: '8:30 PM', label: 'Open discussion & action items' },
      { time: '9:00 PM', label: 'Wrap & drinks' },
    ],
  },
  {
    id: '4',
    slug: 'elite-professionals-night',
    date: 'Monthly Series',
    location: 'London SW15',
    ...
    longDescription: 'A broader format for the people who fall outside the founder track but are no less ambitious. Senior operators, consultants, agency leads, and specialists at the top of their field — the kind of room where one introduction can rewrite your next quarter. Looser structure, sharper attendees.',
    highlights: [
      'Sixty curated guests across functions and industries',
      'Themed introduction rounds in the first hour',
      'Free-form connection time with intentional pairings',
      'Late-evening close with drinks and music',
    ],
    whoFor: [
      'Senior operators and department heads',
      'Independent consultants and specialists',
      'Professionals considering their next move',
    ],
    image: '/images/london/4.webp',
    schedule: [
      { time: '6:30 PM', label: 'Arrival & welcome' },
      { time: '7:00 PM', label: 'Themed introductions' },
      { time: '8:00 PM', label: 'Open networking' },
