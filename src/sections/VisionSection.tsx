          ...
          <ScrollReveal>
             ...
             <div className="space-y-8">
               {values.map((v, i) => (
                 ...
                 >
                   <div className="flex-shrink-0 w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all duration-500">
                     <v.icon className="w-5 h-5 text-primary group-hover:text-white transition-colors" />
                   </div>
                   <div>
                     <h4 className="text-white font-bold text-lg mb-1">{v.title}</h4>
                     <p className="text-white/30 text-sm font-light max-w-xs leading-relaxed">{v.description}</p>
                   </div>
                 </motion.div>
               ))}
             </div>
